  ...
  return regeneratorRuntime.async(function getInvoiceList$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          return _context.abrupt("return", (0, _request["default"])(url, {
            method: 'GET',
            params: params
          }));
  ...
  return regeneratorRuntime.async(function getInvoicePayInfo$(_context2) {
    while (1) {
      switch (_context2.prev = _context2.next) {
        case 0:
          return _context2.abrupt("return", (0, _request["default"])('/invoice/pay_info', {
            method: 'GET',
            params: params
          }));
  ...
  return regeneratorRuntime.async(function getInvoicewaybill$(_context3) {
    while (1) {
      switch (_context3.prev = _context3.next) {
        case 0:
          return _context3.abrupt("return", (0, _request["default"])('/invoice/invoicewaybill', {
            method: 'GET',
            params: params
          }));
  ...
  return regeneratorRuntime.async(function getInvoiceGetInfo$(_context4) {
    while (1) {
      switch (_context4.prev = _context4.next) {
        case 0:
          return _context4.abrupt("return", (0, _request["default"])('/invoice/get_info', {
            method: 'GET',
            params: params
          }));
