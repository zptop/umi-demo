...
const IconFont = createFromIconfontCN({
    scriptUrl: [
        '//at.alicdn.com/t/font_1595958_oyt95e2w0ng.js'
    ]
});
...
const BasicLayout = (props) => {
    ...
    const getMenuByRouter = (list, access) => {
        ...
        if (list && list.length && access && access.length) {
            res = [...list].filter(x => [...access].some(function (y, index) {
        ...
        <Layout>
            ...
            <Layout>
                <Header style={{
                    ...
                    <span><IconFont type="iconqiye" />&nbsp;&nbsp;{props.userInfo.COMPANYNAME}</span>
                    <Dropdown overlay={menu}>
                        <a className={styles.ant_dropdown_link} onClick={e => e.preventDefault()}>
                            您好, {props.userInfo.SHIPPERNAME}&nbsp;&nbsp;<DownOutlined />
                        </a>
                    </Dropdown>
                </Header>
                ...
                <Footer style={{ textAlign: 'center' }}>撮合交易后台系统react版本 ©2020
Created by zp_top</Footer>
            </Layout>
        </Layout>
    );
