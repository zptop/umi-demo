  ...
  effects: {
    ...
    getInvoicePayInfoModel:
      ...
      regeneratorRuntime.mark(function getInvoicePayInfoModel(_ref3, _ref4) {
        ...
        return regeneratorRuntime.wrap(function getInvoicePayInfoModel$(
          _context2,
        ) {
          while (1) {
            switch ((_context2.prev = _context2.next)) {
              ...
              case 4:
                ...
                copy_data = _objectSpread({}, data, {
                  invoice_amount: (0, _tools.accDiv)(
                    data.invoice_amount,
                    100,
                  ).toFixed(2),
                  taxable_amount: (0, _tools.accDiv)(
                    data.taxable_amount,
                    100,
                  ).toFixed(2),
                  create_time: (0, _tools.formatDateYMDHMS)(
                    data.create_time,
                    'year',
                  ),
                });
    ...
    getInvoiceGetInfoModel:
      ...
      regeneratorRuntime.mark(function getInvoiceGetInfoModel(_ref5, _ref6) {
        var value, call, put, res;
        return regeneratorRuntime.wrap(function getInvoiceGetInfoModel$(
          _context3,
        ) {
          while (1) {
    ...
    getInvoicewaybillModel:
      ...
      regeneratorRuntime.mark(function getInvoicewaybillModel(_ref7, _ref8) {
        var value, call, put, res;
        return regeneratorRuntime.wrap(function getInvoicewaybillModel$(
          _context4,
        ) {
          while (1) {
